...
import 'package:flutter_laboratory/common/event/index.dart';
...
enum EmptyPageEnum { order, cart, noData, noNet, search, other ,noCoupon}
...
class _EmptyPageState extends State<EmptyPage> {
  ...
  _setEmptyPageType(type) {
    switch (type) {
      ...
      case EmptyPageEnum.noNet:
        ...
        break;
      case EmptyPageEnum.noCoupon:
        {
          _image = "static/images/noOrder.png";
          _title = "您还没有优惠券哦";
          _clickTitle = "去首页逛逛";
        _clickCallBack = goHomePage;
        }
        break;
      default:
        {
  ...
  goHomePage(){
    NavigatorUtils.pushMainPageByIndex(context, 0);
  }
}
