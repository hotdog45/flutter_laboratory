...
//淡紫#FFF0E6FE
Color kAppPaperColor = Color(0xFFF0E6FE);

Color kAppPaperBlackAlphColor = Color(0x77000000);

Color kAppDivide = Color(0xFFD8D8D8);

Color kAppYellowColor = Color(0xFFFEE203);

Color kAppPr = Color(0xFFA350FF);

Color kAppDeadline = Color(0xFFFFEDEA);

Color kAppDead = Color(0xFFcccccc);

Color kAppHistoryPuchbg= Color(0xFFF9F4FF);

Color kAppPink= Color(0xFFFF9ACE);
